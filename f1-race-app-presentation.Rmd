...
This map shows the location of the Grand Prix on the world map. The figure also adds some track data into a pop up message.
...
This map shows the circuit layout for the race.
